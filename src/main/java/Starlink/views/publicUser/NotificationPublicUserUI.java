...
import Starlink.controllers.publicUser.PublicUserNotificationController;
...
public class NotificationPublicUserUI extends CommonUI{
    ...
    PublicUserNotificationController controller;
    ...
    protected void initialize()// Called when the view is loaded
    {
        ...
        controller = new PublicUserNotificationController();
        try{
            GetAllAlerts();
        }catch(Exception e)
        {
