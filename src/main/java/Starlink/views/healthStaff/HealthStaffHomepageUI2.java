...
public class HealthStaffHomepageUI2 extends CommonUI{
        ...
        Task listLoader = new Task<List<Pane>>() {
            ...
            protected List<Pane> call() throws Exception {
                ...
                for(int i = 0; i < results.size(); i++){
                    FXMLLoader loader = new FXMLLoader(getClass().getResource("/Starlink/views/healthStaff/misc/searchResultRowTemplateHS2.fxml"));
                    loader.setController(HealthStaffHomepageUI2.this);
                    ((HealthStaffHomepageUI2)loader.getController()).setIsRowItem();
